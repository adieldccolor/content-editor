        ...
        win = editor.windowManager.open(
            {
                ...
                data: data,
                classes: 'filemanager',
                file: '/tinymce/filemanager/filemanager.aspx?folder=&type=2&editor=' + editor.id.replace(/\./i, "___") + '&lang=' + tinymce.settings.language,
                filetype: 'image',
	...
	function showDialog(linkList) {
		...
		win = editor.windowManager.open({
			...
			body: [
			    ...
			    {
			        type: 'container', layout: 'flex', classes: 'combobox has-open', label: 'Url', direction: 'row',
			        items:
				    [
					    { name: 'href', type: 'filepicker', filetype: 'file', classes: 'link_' + editor.id.replace(/\./i, "___"), style: "width: 321px;", autofocus: true, onchange: urlChange, onkeyup: urlChange },
					    { name: 'upl_file', type: 'button', icon: 'browse', onclick: openmanager, tooltip: 'Select file' }
				    ]
			    },
				{
				    name: 'text', type: 'textbox', size: 40, label: 'Text to display', classes: 'text_' + editor.id.replace(/\./i, "___"), onchange: function () {
