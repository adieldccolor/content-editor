...
tinymce.PluginManager.add('image', function (editor) {
        ...
        win = editor.windowManager.open(
            {
                ...
                data: data,
                classes: 'filemanager',
                file: '/tinymce/filemanager/filemanager.aspx?folder=&type=1&editor=' + editor.id.replace(/\./i, "___") + '&lang=' + tinymce.settings.language,
                filetype: 'image',
	...
	function showDialog(imageList) {
		...
		var generalFormItems = [
			{ type: 'container', layout: 'flex', classes: 'combobox has-open', label: 'Source', direction: 'row',
				items:
				[
					{ name: 'src', type: 'filepicker', filetype: 'image', classes: 'img_' + editor.id.replace(/\./i, "___"), style: "width: 321px;", autofocus: true, onchange: srcChange },
					{ name: 'upl_img', type: 'button', icon: 'browse', onclick: openmanager, tooltip: 'Select image' }
				]
			},
